...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = ('link', 'title', 'category', 'linktype', 'image')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['link'].widget.attrs = {'class': 'w-75 font-italic pl-2 border-0', 'border': 'none', 'placeholder': 'Link', 'rows': '1'}
        ...
        self.fields['linktype'].widget.attrs = {'class': 'insert-book_select font-italic pl-2 border-0 cursor-pointer', 'border': 'none', 'placeholder': 'Mənbə'}
